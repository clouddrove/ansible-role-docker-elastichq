...
**IMPORTANT:** Since the `master` branch used in `source` varies based on new modifications, we suggest that you use the release versions [here](https://github.com/clouddrove/ansible-role-docker-elastichq/releases).
...
- hosts: localhost
  remote_user: root
  roles:
    - clouddrove.ansible_role_docker_elastichq
```
...
```console
  $ ansible-galaxy install clouddrove.ansible_role_docker_elastichq
```
...
## Feedback
If you come accross a bug or have any feedback, please log it in our [issue tracker](https://github.com/clouddrove/ansible-role-docker-elastichq/issues), or feel free to drop us an email at [hello@clouddrove.com](mailto:hello@clouddrove.com).

If you have found it worth your time, go ahead and give us a ★ on [our GitHub](https://github.com/clouddrove/ansible-role-docker-elastichq)!
